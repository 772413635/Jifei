...
function loadNoJiSuanData() {
    var sum = 0;
    var p  = js_cs.searchProject();
    for (var i = 0; i < p.length; i++) {
        var content = "<tr id=" + p[i].id + "><td class='td_ck'><input type='checkbox' value=" + p[i].id + "/></td><td class='td_cn'>" + p[i].name + "</td><td class='td_cn'>￥" + changeTwoDecimal_f(p[i].price) + "</td><td class='td_cn'>" + p[i].buyUserName + "</td></tr>";
